...
public class Constants {
    ...
    public class Intake {
        public static final int UP_DOWN_SOLENOID_FORWARD = 0;
        public static final int UP_DOWN_SOLENOID_REVERSE = 1;
        public static final int GRAB_SOLENOID_FORWARD = 2;
        public static final int GRAB_SOLENOID_REVERSE = 3;
    }
