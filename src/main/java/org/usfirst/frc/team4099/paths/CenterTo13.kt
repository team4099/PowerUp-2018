...
class CenterTo13 : PathContainer {
    ...
    override fun buildPath() : Path {
        ...
        sWaypoints.add(Waypoint(207.0,220.0,0.0,60.0));
        sWaypoints.add(Waypoint(264.0,290.0,20.0,60.0));
        sWaypoints.add(Waypoint(324.0,304.0,25.0,60.0));
	...
	// WAYPOINT_DATA: [{"position":{"x":21,"y":155},"speed":60,"radius":0,"comment":""},{"position":{"x":76,"y":156},"speed":60,"radius":50,"comment":""},{"position":{"x":96,"y":264},"speed":60,"radius":50,"comment":""},{"position":{"x":153,"y":266},"speed":60,"radius":0,"comment":""},{"position":{"x":221,"y":263},"speed":60,"radius":20,"comment":""},{"position":{"x":242,"y":228},"speed":60,"radius":20,"comment":""},{"position":{"x":207,"y":220},"speed":60,"radius":0,"comment":""},{"position":{"x":264,"y":290},"speed":60,"radius":20,"comment":""},{"position":{"x":324,"y":304},"speed":60,"radius":25,"comment":""},{"position":{"x":324,"y":272},"speed":60,"radius":0,"comment":""}]
	// IS_REVERSED: false
	// FILE_NAME: CenterTo13
}