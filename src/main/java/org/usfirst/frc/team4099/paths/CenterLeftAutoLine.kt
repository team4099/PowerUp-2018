...
class CenterLeftAutoLine : PathContainer {
	...
	// WAYPOINT_DATA: [{"position":{"x":21,"y":155},"speed":60,"radius":0,"comment":""},{"position":{"x":76,"y":156},"speed":60,"radius":50,"comment":""},{"position":{"x":96,"y":264},"speed":60,"radius":50,"comment":""},{"position":{"x":153,"y":266},"speed":60,"radius":0,"comment":""}]
	// IS_REVERSED: false
	// FILE_NAME: CenterLeftAutoLine
}