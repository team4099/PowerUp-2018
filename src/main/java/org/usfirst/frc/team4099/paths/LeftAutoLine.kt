...
class LeftAutoLine : PathContainer {
    ...
    override fun buildPath() : Path {
        ...
        sWaypoints.add(Waypoint(145.0,275.0,0.0,60.0));
	...
	// WAYPOINT_DATA: [{"position":{"x":21,"y":275},"speed":60,"radius":0,"comment":""},{"position":{"x":145,"y":275},"speed":60,"radius":0,"comment":""}]
	// IS_REVERSED: false
	// FILE_NAME: LeftAutoLine
}